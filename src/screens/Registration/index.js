...
export default ({ navigation }) => {
  ...
  const register = async()=>{
    ...
    const response = await API.signUp({username: username, email: email, password: password, re_password: retypePassword})
    ...
    <Container isTransparentStatusBar={false}>
      ...
      <LinearGradient
        ...
        <View style={[styles.flexRow, styles.centerAll]}>
          <Text style={styles.headerText}>{translate('registration_title')}</Text>
        </View>
      </LinearGradient>
      <ScrollView keyboardShouldPersistTaps={'handled'}>
        <View style={[styles.marginTop20]}>
          ...
          <View style={styles.searchHolder}>
            <Icon name={'user-circle-o'} size={25} color={Colors.gray_light} style={styles.marginRight8} />
            <TextInput
              style={styles.searchInput}
          ...
          <View style={styles.searchHolder}>
            <Icon name={'envelope'} size={25} color={Colors.gray_light} style={styles.marginRight8} />
            <TextInput
              style={styles.searchInput}
          ...
          <LinearGradient
            ...
            <TouchableOpacity onPress={()=>register()} style={[styles.flexRow, styles.centerAll]}>
