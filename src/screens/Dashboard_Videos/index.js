    ...
    <Container isTransparentStatusBar={false}>
      ...
      <ScrollView>
        ...
        <View style={[styles.flexRow, styles.justifyCenter]}>
          <TouchableOpacity
            onPress={() => setModalVideo(VIDEOS['trending'][0])}
            style={[styles.flex1, styles.paddingHorizontal10]}>
            <ImageBackground
              source={video_icon_background_blue}
              style={styles.iconBackground}>
              <Image source={video1} style={styles.iconvideo} />
            </ImageBackground>
            <Text numberOfLines={2} style={styles.videoText}>
              {VIDEOS['trending'][0].name}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => setModalVideo(VIDEOS['trending'][1])}
            style={[styles.flex1, styles.paddingHorizontal10]}>
            <ImageBackground
              source={video_icon_background_blue}
              style={styles.iconBackground}>
            ...
            <Text numberOfLines={2} style={styles.videoText}>
              {VIDEOS['trending'][1].name}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => setModalVideo(VIDEOS['trending'][2])}
            style={[styles.flex1, styles.paddingHorizontal10]}>
            <ImageBackground
              source={video_icon_background_blue}
              style={styles.iconBackground}>
        ...
        <View style={[styles.flexRow]}>
          <TouchableOpacity
            onPress={() => setModalVideo(VIDEOS['new'][0])}
            style={[
          ...
          <TouchableOpacity
            onPress={() => setModalVideo(VIDEOS['new'][1])}
            style={[
              styles.videoItem,
              styles.paddingHorizontal10,
              styles.alignCenter,
        ...
        <View style={[styles.flexRow]}>
          <TouchableOpacity
            onPress={() => setModalVideo(VIDEOS['lectures'][0])}
            style={[
              styles.videoItem,
              styles.paddingHorizontal10,
              styles.alignCenter,
        ...
        {modalVideo ? (
          <View style={[styles.flex1, styles.centerAll]}>
            ...
            <View style={[styles.flexRow, styles.marginTop30]}>
              ...
              <Button
                onPress={() => Linking.openURL(modalVideo['link'])}
