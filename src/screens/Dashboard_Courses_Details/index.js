...
export default ({ route, navigation }) => {
  ...
  const [formData, setFormData] = useState({ username: '', age: '', gender: '', dob: '', whtsapp: '', email: '', phone: '', address: '', education: '', edu_board: '', edu_class: '', isla_edu: '', isla_board: '', isla_class: '' })
  ...
  return (
    <Container isTransparentStatusBar={false}>
      ...
      <View style={[styles.flexRow, styles.spaceAround, styles.marginBottom10]}>
        <TouchableOpacity onPress={() => checkPermission()} style={styles.button2}>
        ...
        <ScrollView
          ...
          <View style={styles.searchHolder}>
            <RNPickerSelect
              ...
              style={pickerSelectStyles}
              onValueChange={(value) => setFormData({ ...formData, isla_edu: value })}
              items={[
          ...
          <View style={styles.searchHolder}>
            <TextInput
              style={styles.searchInput}
              onChangeText={(text) => setFormData({ ...formData, isla_board: text })}
          ...
          <View style={styles.searchHolder}>
            <TextInput
              style={styles.searchInput}
              onChangeText={(text) => setFormData({ ...formData, isla_class: text })}
          ...
          <LinearGradient
            ...
            <TouchableOpacity onPress={()=>applyCourse()} style={[styles.flexRow, styles.centerAll]}>
              <Text style={styles.headerText}>SUBMIT</Text>
            </TouchableOpacity>
          </LinearGradient>

          <TouchableOpacity onPress={()=>setShowModal(false)} style={styles.signupHolder}>
            <Text style={styles.create}><Text style={styles.signup}>Close</Text></Text>
          </TouchableOpacity>
        </ScrollView>
      </Modal>
    </Container>
