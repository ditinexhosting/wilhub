  ...
  const renderItem = ({item}) => {
    return (
      <View style={styles.imageContainer}>
        ...
        <Text numberOfLines={2} style={styles.personTitle}>
          {item.name}
        </Text>
        {item.designation && (
          <Text numberOfLines={2} style={styles.personDesignation}>
            {item.designation}
          </Text>
        )}
      </View>
    ...
    <Container isTransparentStatusBar={false}>
      <ImageBackground source={about_us_background} style={styles.background}>
        ...
        <ScrollView>
          ...
          {/*Advisory Board */}
          <View
            style={[styles.flexRow, styles.alignCenter, styles.contentHeader]}>
